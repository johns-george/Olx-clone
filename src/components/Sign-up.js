...
username:username
  ...
  return (
    <div className="flex justify-center items-center h-screen ">
        <form  onSubmit={handlesubmit}className="border-2 border-gray-500 rounded-lg py-4">
            ...
            <div className="pl-4">
                ...
                }} type="username" className='text-lg' placeholder='Enter Your Username' />
                <h2 className='text-xl'>Name</h2>
                <input className='text-lg' value={name} onChange={(e)=>{
                  setName(e.target.value)
                }} type="text" placeholder='Enter your Name'/>
                <h2 className='text-xl'>Mobile</h2>
                <input className='text-lg' value={mobile} onChange={(e)=>{
                  setMobile(e.target.value)
                }} type="text" placeholder='Enter your Number' />
                <h2 className='text-xl'>Password</h2>
                <input className='text-lg' value={password} onChange={(e)=>{
                  setPassword(e.target.value)
                }} type="password" placeholder='Enter your Password' />
               <div className='mt-2 flex justify-between pr-4 py-1 '><button type='submit' className='hover:text-black hover:bg-gray-300 cursor-pointer bg-gray-400 text-white px-5 text-lg'>Sign-Up</button>
                <button className='bg-gray-400 text-white hover:text-black hover:bg-gray-300 px-5 py-1 cursor-pointer text-lg' onClick={loginbuttonclick} disabled={loading}>Log-In</button>
